...
export default function CheckoutPage() {
  ...
  const handlePaymentSuccess = async (paymentIntentId: string) => {
    try {
        ...
        alert("Payment succeeded, but reservation update failed. Please contact support.");
    }
  };
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
        ...
        <Typography variant="h4" gutterBottom sx={{ fontWeight: 'bold' }}>
            {modificationReservationId ? "Confirm Upgrade" : "Secure Checkout"}
        </Typography>
        ...
        >
            <DialogContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 }}>
                ...
                <Typography variant="h4" fontWeight="bold">
                    {modificationReservationId ? "Upgrade Confirmed!" : "Payment Successful!"}
                </Typography>
                <Typography variant="body1" color="text.secondary">
                    Your reservation has been {modificationReservationId ? "updated" : "confirmed"}. You will receive an email shortly with your details.
                </Typography>
            </DialogContent>
